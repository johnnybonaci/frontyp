...
export interface RPCReportListFiltersFormValues {
  pubId: Option[]
  subId: Option | null
  state: Option[]
...
interface RPCReportFiltersProps {
  onCancel: () => void
  onApply: (data: any) => void
  isSearching?: boolean
  initialFilters?: RPCReportListFiltersFormValues
}
...
export const DEFAULT_FILTERS: RPCReportListFiltersFormValues = {
  pubId: [],
  subId: null,
  state: [],
  trafficSource: [],
...
const RPCReportFilters: FC<RPCReportFiltersProps> = ({
  onCancel,
  onApply,
  isSearching = false,
  initialFilters = DEFAULT_FILTERS,
}) => {
  const { t } = useTranslation('features', { keyPrefix: 'RPCReport.filters' })
...
export default RPCReportFilters
