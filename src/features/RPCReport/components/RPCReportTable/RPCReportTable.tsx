...
import RPCReportItemCard from 'components/RPCReportItemCard'
...
const RPCReportTable: FC<CallReportTableProps> = ({ ...restOfProps }) => {
  return <SortableTable {...restOfProps} collapsible CollapsableElement={RPCReportItemCard} />
}

export default RPCReportTable
