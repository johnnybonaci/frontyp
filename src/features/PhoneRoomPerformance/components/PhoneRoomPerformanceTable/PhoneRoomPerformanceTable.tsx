...
interface PhoneRoomPerformanceTableProps
  extends PaginatedTableProps,
    SortableTableProps,
    TableWithActionsProps,
    TableProps {}

const PhoneRoomPerformanceTable: FC<PhoneRoomPerformanceTableProps> = ({ ...restOfProps }) => {
  return <SortableTable {...restOfProps} />
}

export default PhoneRoomPerformanceTable
