...
import { type BuyersItem } from 'features/Settings/types/Buyers'
...
interface BuyersTableProps
  extends PaginatedTableProps,
    ...
    TableProps {
  onClickEdit: (buyersItem: BuyersItem) => void
}

const BuyersTable: FC<BuyersTableProps> = ({ onClickEdit, ...restOfProps }) => {
  const { t } = useTranslation('features', { keyPrefix: 'Settings.buyers.actions' })
